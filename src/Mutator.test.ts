...
describe('mutate', () => {
    ...
    test('sets properly', () => {
        let mutator = new Mutator({bob: {age: 4}})
    ...
    test('pushs into array', () => {
        let mutator = new Mutator({bob: {friends: ['greg']}})
